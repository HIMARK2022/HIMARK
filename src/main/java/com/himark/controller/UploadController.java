...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		String uploadFolder = "e:/upload/tmp";
	...
	public ResponseEntity<List<BoardAttachVO>> uploadAjaxPost(MultipartFile[] uploadFile) {
		...
		String uploadFolder = "e:\\upload\\tmp";
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("e:\\upload\\tmp\\" + fileName);
		log.info("file : " + file);
	...
	public ResponseEntity<Resource> downloadFile(String fileName){
		...
		Resource resource = new FileSystemResource("e:\\upload\\tmp\\" + fileName);
	...
	//서버에서 첨부파일 삭제
	@PostMapping({"/general/deleteFile","/approver/deleteFile"})
	@ResponseBody
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		try {
			file = new File("e:\\upload\\tmp\\" + URLDecoder.decode(fileName, "UTF-8"));
